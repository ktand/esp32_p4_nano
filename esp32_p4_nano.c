...
#if CONFIG_BSP_LCD_TYPE_800_1280_10_1_INCH || CONFIG_BSP_LCD_TYPE_800_1280_10_1_INCH_A || CONFIG_BSP_LCD_TYPE_800_1280_8_INCH_A || CONFIG_BSP_LCD_TYPE_720_1280_9_INCH_B ||                            \
...
esp_err_t bsp_display_brightness_set(int brightness_percent)
{
    ...
    CONFIG_BSP_LCD_TYPE_720_1280_9_INCH_B || CONFIG_BSP_LCD_TYPE_720_1280_10_1_INCH_B
...
esp_err_t bsp_touch_new(const bsp_touch_config_t *config, esp_lcd_touch_handle_t *ret_touch)
{
    ...
    const esp_lcd_touch_config_t tp_cfg = {
        ...
        .flags =
            {
#if CONFIG_BSP_LCD_TYPE_800_1280_10_1_INCH || CONFIG_BSP_LCD_TYPE_800_1280_10_1_INCH_A || CONFIG_BSP_LCD_TYPE_720_1280_7_INCH_A || CONFIG_BSP_LCD_TYPE_720_1280_9_INCH_B ||                            \
    CONFIG_BSP_LCD_TYPE_720_1280_10_1_INCH_B
                .swap_xy = 0,
                .mirror_x = 0,
                .mirror_y = 0,
...
static lv_display_t *bsp_display_lcd_init(const bsp_display_cfg_t *cfg)
{
    ...
    const lvgl_port_display_cfg_t disp_cfg = {.io_handle = lcd_panels.io,
...
lv_display_t *bsp_display_start(void)
{
    ...
    cfg.lvgl_port_cfg.task_stack += 2048; // Add extra stack for display driver, as some of them may require more stack than typical LVGL task
